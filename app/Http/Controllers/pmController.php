...
class pmController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/pm')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = pmtables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/pm')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/pm')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = pmtables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/pm')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/pm')->with('error', 'Data tidak ditemukan');
        }
    }
