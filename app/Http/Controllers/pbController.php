...
class pbController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/pb')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = pbtables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/pb')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/pb')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = pbtables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/pb')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/pb')->with('error', 'Data tidak ditemukan');
        }
    }
