...
class seController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/se')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = setables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/se')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/se')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = setables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/se')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/se')->with('error', 'Data tidak ditemukan');
        }
    }
