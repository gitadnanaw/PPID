...
class pmaController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/pma')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = pmatables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/pma')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/pma')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = pmatables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/pma')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/pma')->with('error', 'Data tidak ditemukan');
        }
    }
