...
class dikecualikanController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        $newData = new dikecualikantables();
        $newData->keterangan = $request->keterangan_form;
        $newData->tahun = $request->thn_form;
        $newData->file = $filePath;
        $newData->save();

        return redirect('/dikecualikan')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = dikecualikantables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/dikecualikan')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/dikecualikan')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = dikecualikantables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/dikecualikan')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/dikecualikan')->with('error', 'Data tidak ditemukan');
        }
    }
