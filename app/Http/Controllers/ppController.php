...
class ppController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/pp')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = pptables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/pp')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/pp')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = pptables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/pp')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/pp')->with('error', 'Data tidak ditemukan');
        }
    }
