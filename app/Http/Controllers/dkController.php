...
class dkController extends Controller
{
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = dktables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/dk')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/dk')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = dktables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/dk')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/dk')->with('error', 'Data tidak ditemukan');
        }
    }
