...
class iadmController extends Controller
{
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = iadmtables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/iadm')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/iadm')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = iadmtables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/iadm')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/iadm')->with('error', 'Data tidak ditemukan');
        }
    }
