...
class rbController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/rb')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = rbtables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/rb')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/rb')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = rbtables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/rb')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/rb')->with('error', 'Data tidak ditemukan');
        }
    }
