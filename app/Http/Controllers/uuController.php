...
class uuController extends Controller
{
    public function input_data(Request $request)
    {
        ...
        return redirect('/uu')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = uutables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/uu')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/uu')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = uutables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/uu')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/uu')->with('error', 'Data tidak ditemukan');
        }
    }
