...
class ikegController extends Controller
{
    ...
    public function update_data(Request $request)
    {
        ...
        $dataToUpdate = ikegtables::find($request->id);
        if ($dataToUpdate) {
            ...
            return redirect('/ikeg')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect('/ikeg')->with('error', 'Data tidak ditemukan');
        }
    }

    public function del_data($id)
    {
        $dataToDelete = ikegtables::find($id);
        if ($dataToDelete) {
            ...
            return redirect('/ikeg')->with('success', 'Data berhasil dihapus');
        } else {
            return redirect('/ikeg')->with('error', 'Data tidak ditemukan');
        }
    }
